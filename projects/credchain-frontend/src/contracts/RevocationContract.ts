...
export type RevocationContractComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<RevocationContractComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<RevocationContractComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<RevocationContractComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
